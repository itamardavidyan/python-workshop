...
# Data Types:
    ...
    # - Dictionary - {'Hello': 'World', 'Hi': 'Bye', ... , 'Good': 'Bye'}
    # - Boolean - True, False

# Conditions:
    # - if(Itamar is the highest at work): Give_him_a_raise()
    # - if(True): doSomething()
    # - if(False): doNothing()
    # - if(x > 3): print("higher than 2") else: print("smaller than 3")
    # - switch(): case 1: do_1() case 2: do_2() ... case n: do_n()
...
# print((nums[9-1] + nums[0]) / -2)
# print(nums[nums[0]])
# print(nums_2d[2][2])
# print(nums[len(nums) - 1])
# print(nums[-1])
# print(nums[2-1] * nums[2-1])
# print(nums[3-1] * nums[3-1])

# 2-2:
# if('Itamar is the highest at work'):
#     print('Always True')
...
# # take user input
# m = input('input a character : ')
# print('The name of month #' + str(m) + ' is : ' + switch_func(m))
...
# 2-8:
# nums = [1, 1, 2, 4, 3, 9, 4, 16, 5, 25, 6, 36]
# for index in range(len(nums)):
#     if (index % 2 == 0):
#         print(str(nums[index]) + '^2 = ' + str(nums[index + 1]))
